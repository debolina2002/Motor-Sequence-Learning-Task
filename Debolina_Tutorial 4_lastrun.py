...
expName = 'Debolina_Tutorial 4'  # from the Builder filename that created this script
expInfo = {
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\debol\\Desktop\\PsychoPy\\Debolina_Tutorial 4_lastrun.py',
...
trials = data.TrialHandler(nReps=12.0, method='sequential', 
    ...
    trialList=data.importConditions('C:/Users/debol/Desktop/PsychoPy/sequence_conditions 2.csv'),
